...
const Character CHARACTER_F = CHARACTER(4, 7, false, INDEX_LETTERS_START + 5);
...
const Character CHARACTER_J = CHARACTER(2, 3, false, INDEX_LETTERS_START + 9);
const Character CHARACTER_K = CHARACTER(4, 8, false, INDEX_LETTERS_START + 10);
const Character CHARACTER_L = CHARACTER(2, 3, false, INDEX_LETTERS_START + 11);
...
const Character CHARACTER_R = CHARACTER(3, 6, false, INDEX_LETTERS_START + 17);
const Character CHARACTER_S = CHARACTER(4, 8, false, INDEX_LETTERS_START + 18);
const Character CHARACTER_T = CHARACTER(4, 7, false, INDEX_LETTERS_START + 19);
const Character CHARACTER_U = CHARACTER(4, 8, false, INDEX_LETTERS_START + 20);
const Character CHARACTER_V = CHARACTER(5, 9, false, INDEX_LETTERS_START + 21);
const Character CHARACTER_W = CHARACTER(5, 10, false, INDEX_LETTERS_START + 22);
const Character CHARACTER_X = CHARACTER(5, 9, false, INDEX_LETTERS_START + 23);
...
const Character CHARACTER_CAPITAL_I = CHARACTER(1, 2, false, INDEX_LETTERS_CAPITAL_START + 8);
